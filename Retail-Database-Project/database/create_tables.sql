...
CREATE TABLE Product_Units (
    UnitID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Employee_Salaries (
    SalaryID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Branch_Types (
    BranchTypeID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    TypeName VARCHAR2(50) NOT NULL,
    Description CLOB
)
TABLESPACE master_ts;
...
CREATE TABLE Branch_Status (
    BranchStatusID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    StatusName VARCHAR2(50) NOT NULL,
    Description CLOB
)
TABLESPACE master_ts;
...
CREATE TABLE Branch_Managers (
    BranchManagerID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Branch_Employees (
    BranchEmployeeID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    BranchID NUMBER NOT NULL,
    EmployeeID NUMBER NOT NULL,
...
CREATE TABLE Sale_Channels (
    ChannelID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Orders (
    ...
    CONSTRAINT fk_order_channel FOREIGN KEY (ChannelID) REFERENCES Sale_Channels(ChannelID),
...
CREATE TABLE Payment_Methods (
    MethodID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Order_Invoices (
    OrderInvoiceID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    OrderID NUMBER NOT NULL,
    InvoiceID NUMBER NOT NULL,
